...
class Ollama(LLMProvider):
        ...
        def _extract_structure(self, file_extension:str, base_64_string: str, file_path:str) -> Dict:
            """Extracts the structure for file or image input to be sent to the Ollama API.
        ...
        async def _process_single_file(self, file_path: str) -> Dict:
            """Processes a single local file into the Ollama API format.
        ...
        async def _process_files(self, files_paths: List[str]) -> List[Dict]:
            """Processes multiple files asynchronously into the Ollama API format.
